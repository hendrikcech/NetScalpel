...
func init() {
	Register(Procedure{
		Name:        "prograte",
		Description: "Progressive-duration rate tests in random order at a fixed rate (70 Mbps UL, 700 Mbps DL).",
		Mode:        PerDirection,
		Run:         ProgressiveRate,
		Params: []ParamSpec{
			{
				...
				Default:     []uint{100, 200, 300, 350, 400, 450, 500},
			},
		},
...
func ProgressiveRate(e *experiment.Executor, ts time.Time, resultPath string, params experiment.ParamMap) error {
